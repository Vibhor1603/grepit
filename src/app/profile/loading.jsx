...
export default function ProfileLoading() {
  return (
    <div className="min-h-screen bg-vb-bg">
      <div className="h-14 md:h-16 border-b border-white/[0.06] flex items-center px-4 md:px-6">
        <div className="w-16 h-5 rounded bg-white/[0.04]" />
        <div className="ml-auto flex gap-2">
          <div className="w-24 h-8 rounded-lg bg-white/[0.04]" />
          <div className="w-16 h-8 rounded-lg bg-white/[0.04]" />
        </div>
      </div>
      <div className="max-w-[900px] mx-auto px-4 md:px-6 py-8 md:py-10 space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-2">
            <div className="h-5 w-36 rounded bg-white/[0.04] animate-pulse" />
