      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.banner}>
          <View style={s.bannerLeft}>
            <Text style={s.bannerLogo}>grep<Text style={s.bannerAccent}>it</Text></Text>
        ...
        <View style={s.footer} fixed>
          <Text style={s.footerSub}>Generated by grepit</Text>
          <View style={{ alignItems: 'flex-end' }}>
            <Text style={s.certified}>✓ GREPIT CERTIFIED</Text>
